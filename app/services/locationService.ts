  ...
  search: async (query: string): Promise<LocationResult[]> => {
    ...
    try {
      ...
      return data.features.map((feature: any) => {
        ...
        const continent = countryCode ? COUNTRY_TO_CONTINENT[countryCode] : undefined;
